      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 flex items-center gap-4 text-xs text-zinc-500">
            <span>by <span className="font-medium text-zinc-700 dark:text-zinc-300">{contribution.userName}</span></span>
            <span>•</span>
    ...
    <div className="flex flex-col gap-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700 dark:text-amber-300">
              ...
              <a href="https://github.com" className="underline hover:no-underline">GitHub</a>{" "}
              or <a href="https://discord.gg" className="underline hover:no-underline">Discord</a> to contribute!
            </p>
          </div>
        </div>
      </Card>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="p-4 text-center">
          ...
          <p className="text-sm text-zinc-500">Total Contributions</p>
        </Card>
        <Card className="p-4 text-center">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Card className="p-4 border-indigo-200 bg-indigo-50/50 dark:border-indigo-900/30 dark:bg-indigo-950/20">
            <div className="flex items-center gap-3">
              <span className="text-2xl">🎯</span>
              <div>
                <h3 className="font-semibold text-zinc-900 dark:text-white">Submit a Challenge</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400">Create a new coding challenge with tests</p>
              </div>
            </div>
          ...
          <Card className="p-4 border-green-200 bg-green-50/50 dark:border-green-900/30 dark:bg-green-950/20">
            <div className="flex items-center gap-3">
              <span className="text-2xl">✅</span>
              <div>
                <h3 className="font-semibold text-zinc-900 dark:text-white">Share a Solution</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400">Alternative approaches to existing challenges</p>
              </div>
            </div>
          ...
          <Card className="p-4 border-blue-200 bg-blue-50/50 dark:border-blue-900/30 dark:bg-blue-950/20">
            <div className="flex items-center gap-3">
              <span className="text-2xl">📄</span>
              <div>
                <h3 className="font-semibold text-zinc-900 dark:text-white">Suggest a Paper</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400">Add important research to our reading list</p>
              </div>
            </div>
          ...
          <Card className="p-4 border-amber-200 bg-amber-50/50 dark:border-amber-900/30 dark:bg-amber-950/20">
            <div className="flex items-center gap-3">
              <span className="text-2xl">🔧</span>
              <div>
                <h3 className="font-semibold text-zinc-900 dark:text-white">Report a Bug</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400">Fix errors in challenges or content</p>
              </div>
            </div>
          ...
          <Card className="p-4 border-purple-200 bg-purple-50/50 dark:border-purple-900/30 dark:bg-purple-950/20">
            <div className="flex items-center gap-3">
              <span className="text-2xl">🌐</span>
              <div>
                <h3 className="font-semibold text-zinc-900 dark:text-white">Translate Content</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400">Help localize lessons and challenges</p>
              </div>
            </div>
          ...
          <Card className="p-4 flex items-center justify-center border-dashed">
            <button className="text-sm font-medium text-zinc-500 hover:text-zinc-900 dark:hover:text-white">
              + Start Contributing
            </button>
          </Card>
        </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/50">
                ...
                <th className="px-4 py-3 text-left font-medium text-zinc-500">Contributor</th>
                <th className="px-4 py-3 text-left font-medium text-zinc-500">Contributions</th>
                <th className="px-4 py-3 text-left font-medium text-zinc-500">XP Earned</th>
              ...
              {topContributors.map((contributor, idx) => (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    ...
                    <span className="text-zinc-600 dark:text-zinc-400">{contributor.stats.totalContributions}</span>
                  </td>
                  <td className="px-4 py-3">
      ...
      <section>
        ...
        <Card className="p-5">
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              <h3 className="font-medium text-zinc-900 dark:text-white">✅ Good Contributions</h3>
            ...
            <div>
              <h3 className="font-medium text-zinc-900 dark:text-white">❌ Avoid</h3>
              <ul className="mt-2 space-y-1 text-sm text-zinc-600 dark:text-zinc-400">
