  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900 py-16">
      <div className="mx-auto max-w-2xl px-6">
        ...
        {/* Checkout Card */}
        <div className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8 shadow-lg">
          {/* Tier Selection */}
          <div className="mb-8">
            <label className="text-sm font-semibold text-zinc-900 dark:text-white mb-3 block">
              Select Plan
            </label>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    <h3 className="font-semibold text-zinc-900 dark:text-white">Monthly</h3>
                    {selectedBilling === "monthly" && (
                      <CheckIcon />
                    )}
                  </div>
                  <p className="text-2xl font-bold text-zinc-900 dark:text-white">
                    {tierConfig.price.displayMonthly}
                    <span className="text-sm font-normal text-zinc-600 dark:text-zinc-400">/mo</span>
                  </p>
                </button>
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-1">
                    <h3 className="font-semibold text-zinc-900 dark:text-white">Annual</h3>
                    {selectedBilling === "annual" && (
                      <CheckIcon />
                    )}
                  </div>
                  <p className="text-2xl font-bold text-zinc-900 dark:text-white">
                    {tierConfig.price.displayAnnual}
                    <span className="text-sm font-normal text-zinc-600 dark:text-zinc-400">/yr</span>
                  </p>
          ...
          {/* Order Summary */}
          <div className="mb-8 rounded-2xl bg-zinc-50 dark:bg-zinc-800/50 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-zinc-600 dark:text-zinc-400">Billing</span>
              ...
              {selectedTier === "team" && (
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-zinc-900 dark:text-white">5 included</span>
                </div>
              )}
              <div className="border-t border-zinc-200 dark:border-zinc-700 pt-3 mt-3">
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-500 mt-1 text-right">
          ...
          {/* What's Included */}
          <div className="mb-8">
            <h3 className="font-semibold text-zinc-900 dark:text-white mb-3">What&apos;s included:</h3>
        ...
        {/* Trust Badges */}
        <div className="mt-8 flex items-center justify-center gap-6 text-xs text-zinc-500 dark:text-zinc-500 flex-wrap">
...
function TierButton({ selected, onClick, title, subtitle, price, popular, badge }: TierButtonProps) {
  return (
    ...
    >
      ...
      <p className="text-lg font-bold text-zinc-900 dark:text-white mt-2">{price}</p>
    </button>
  );
}
...
function CheckoutLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900 py-16">
      <div className="mx-auto max-w-2xl px-6">
        <div className="text-center mb-12">
          <div className="h-8 w-64 bg-zinc-200 dark:bg-zinc-800 rounded animate-pulse mx-auto"></div>
          <div className="h-4 w-48 bg-zinc-200 dark:bg-zinc-800 rounded animate-pulse mx-auto mt-2"></div>
        </div>
        <div className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-8 shadow-lg">
          <div className="space-y-4">
            <div className="h-12 bg-zinc-100 dark:bg-zinc-800 rounded animate-pulse"></div>
            <div className="h-12 bg-zinc-100 dark:bg-zinc-800 rounded animate-pulse"></div>
            <div className="h-32 bg-zinc-100 dark:bg-zinc-800 rounded animate-pulse"></div>
            <div className="h-14 bg-zinc-200 dark:bg-zinc-700 rounded animate-pulse"></div>
          </div>
        </div>
      </div>
    </div>
