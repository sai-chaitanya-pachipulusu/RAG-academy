...
export default function CompareRerankingPage() {
  return (
    <div className="flex flex-col gap-6">
      <header>
        <p className="text-xs text-zinc-500 dark:text-zinc-400">Compare / Reranking</p>
      ...
      <Card className="p-5">
        ...
        <pre className="mt-4 overflow-x-auto rounded-2xl border border-zinc-200 bg-white/60 p-4 text-xs text-zinc-800 dark:border-white/10 dark:bg-white/[0.03] dark:text-zinc-200">{`retrieve top-50 (fast)
rerank top-50 (slow)
...
generate with citations`}</pre>
      ...
      <Card className="p-5">
        ...
        <p className="mt-2 text-sm leading-7 text-zinc-600 dark:text-zinc-300">
          ...
          <span className="font-medium text-zinc-950 dark:text-zinc-50"> shape of the solution</span> (cross‑encoder vs cascade vs LLM),
      ...
      <Card className="p-5">
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-3">
          <CardExternalLink href="https://cohere.com/pricing" className="p-4">
            ...
            <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">Rerank API</p>
          </CardExternalLink>
          <CardExternalLink href="https://openai.com/pricing" className="p-4">
            <p className="text-sm font-medium">OpenAI</p>
            <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">LLM listwise rerank</p>
          </CardExternalLink>
          <CardExternalLink href="https://huggingface.co/models?pipeline_tag=text-ranking" className="p-4">
            ...
            <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">Open-source rerankers</p>
          </CardExternalLink>
        </div>
      </Card>
