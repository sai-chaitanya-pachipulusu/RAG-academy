...
export default function VectorDbLabPage() {
  return (
    <div className="flex flex-col gap-6">
      <header>
        <p className="text-xs text-zinc-500 dark:text-zinc-400">Compare / Vector DBs</p>
          ...
          <table className="w-full min-w-[720px] border-separate border-spacing-0">
            <thead>
              <tr className="text-left text-xs text-zinc-500 dark:text-zinc-400">
                <th className="border-b border-zinc-200 px-3 py-2 dark:border-white/10">
                  Database
                </th>
                <th className="border-b border-zinc-200 px-3 py-2 dark:border-white/10">
                  p50 latency
            ...
            <tbody className="text-sm">
              {[
                ...
                <tr key={row[0]} className="text-zinc-800 dark:text-zinc-200">
                  {row.map((cell, idx) => (
                    <td
                      key={`${row[0]}-${idx}`}
                      className={[
                        "border-b border-zinc-200 px-3 py-2 dark:border-white/10",
                        idx === 0 ? "font-medium text-zinc-950 dark:text-zinc-50" : "",
                      ].join(" ")}
                    >
                      {cell}
                    </td>
          ...
          <table className="w-full min-w-[860px] border-separate border-spacing-0">
            ...
            <tbody className="text-sm">
              {[
                ...
                <tr key={r.db} className="text-zinc-800 dark:text-zinc-200">
                  {[
                    r.db,
                    r.hybrid,
                    r.filtering,
      ...
      <Card className="p-5">
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-2">
          <div className="rounded-2xl border border-zinc-200 bg-white/60 p-4 dark:border-white/10 dark:bg-white/[0.03]">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-full border border-zinc-200 bg-white px-4 py-2 text-sm font-medium text-zinc-900 hover:bg-zinc-50 dark:border-white/10 dark:bg-white/[0.03] dark:text-zinc-100 dark:hover:bg-white/[0.06]"
          >
