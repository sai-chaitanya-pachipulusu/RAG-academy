...
export default function ChunkingComparePage() {
  return (
    <div className="flex flex-col gap-6">
      <header>
        <p className="text-xs text-gray-500 dark:text-gray-400">Compare / Chunking</p>
      ...
      <Card className="p-5">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-3">
          <div>
            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Small (128-256 tokens)</p>
            <p className="mt-1 text-sm text-gray-700 dark:text-gray-300">
              High precision, low recall. Good for FAQ, definitions.
            </p>
          </div>
          <div>
            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Medium (512-1024 tokens)</p>
            <p className="mt-1 text-sm text-gray-700 dark:text-gray-300">
              Balanced. Good default for most RAG applications.
            </p>
          </div>
          <div>
            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Large (2000+ tokens)</p>
            <p className="mt-1 text-sm text-gray-700 dark:text-gray-300">
