...
export default function CompareSecurityPage() {
  return (
    <div className="flex flex-col gap-6">
      <header>
        <p className="text-xs text-gray-500 dark:text-gray-400">Compare / Security</p>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-7 text-gray-600 dark:text-gray-300">
          ...
          <span className="font-medium text-gray-950 dark:text-gray-50"> never let unauthorized or untrusted text reach the model</span>.
