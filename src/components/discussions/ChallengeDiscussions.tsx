  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="font-semibold text-gray-900 dark:text-white">Discussions</h2>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 dark:bg-indigo-600 dark:hover:bg-indigo-500 cursor-pointer"
        >
      ...
      {error && (
        <Card className="p-6 text-center">
          ...
          <button
            ...
            className="mt-3 text-sm text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 cursor-pointer"
          >
            Try again
          </button>
        </Card>
      ...
      {isLoading && (
        <Card className="p-8">
          <div className="flex items-center justify-center">
            ...
            <span className="ml-2 text-sm text-gray-500">Loading discussions...</span>
          </div>
        </Card>
      )}
      ...
      {!isLoading && !error && threads.length === 0 && (
        <Card className="p-8 text-center">
          ...
          <p className="mt-1 text-sm text-gray-400">Be the first to start a conversation!</p>
          <button
            onClick={() => setShowCreateForm(true)}
            className="mt-4 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 cursor-pointer"
          >
            Start a Discussion
          </button>
        </Card>
  ...
  return (
    <Card className="p-4">
      ...
      <a
        ...
        className="mt-3 inline-block text-xs font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 cursor-pointer"
      >
