  ...
  return (
    <div className="rounded-2xl border border-zinc-200 p-5 dark:border-zinc-800">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="text-sm font-medium">LLM (Bring Your Own Key)</p>
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <label className="grid gap-1">
            ...
            <input
              value={providerLabel}
              disabled
              className="h-10 w-full rounded-2xl border border-zinc-200 bg-zinc-50 px-4 text-sm text-zinc-600 outline-none dark:border-zinc-800 dark:bg-zinc-900/40 dark:text-zinc-300"
            />
          </label>
