        ...
        <div className="flex items-center gap-2">
          {onCompare && (
            <button
              type="button"
              onClick={onCompare}
              className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-white/10 dark:bg-white/[0.05] dark:text-gray-300 dark:hover:bg-white/[0.1] cursor-pointer"
            >
              Compare
            </button>
          )}
      ...
      {submission.testsTotal > 0 && (
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Test Results</p>
        ...
        <div className="mb-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-white/10 dark:bg-white/[0.05] dark:text-gray-300 dark:hover:bg-white/[0.1] cursor-pointer"
            >
            ...
            {onRevert && (
              <button
                ...
                className="rounded-lg bg-indigo-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-indigo-700 cursor-pointer"
              >
                Revert to This Code
              </button>
            )}
          ...
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-gray-900">
            ...
            <div className="mt-6 flex justify-end gap-3">
              <button
                ...
                className="rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/10 cursor-pointer"
              >
                Cancel
              </button>
              <button
