      ...
      <Card className="p-6">
        <div className="mb-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500">Your learning activity over the past year</p>
          </div>
        ...
        <Card className="p-6">
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-zinc-500">Areas that need attention</p>
            </div>
        ...
        <Card className="p-6">
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-zinc-500">Challenges completed over time</p>
            </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-zinc-500">Fastest Challenge</p>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-zinc-500">Slowest Challenge</p>
              <p className="font-semibold">
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Per challenge</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card className="p-6">
        <div className="mb-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500">Detailed breakdown of time spent</p>
          </div>
          <select
            value={sortBy}
      ...
      <Card className="p-6">
        <div className="mb-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500">Individual skill gaps and recommendations</p>
          </div>
          <select
            value={filter}
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <div className="mb-4">
          ...
          <p className="text-sm text-zinc-500">Challenges completed in the last 7 days</p>
        </div>
    ...
    <div className="flex items-center justify-between rounded-lg border border-zinc-100 p-3 dark:border-zinc-800">
      ...
      <div className="flex items-center gap-4">
        <div className="text-right">
          ...
          <p className="text-xs text-zinc-400">proficiency</p>
        </div>
        <div className="h-8 w-24 overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-800">
          <div
    ...
    <div className="rounded-lg border border-zinc-100 p-4 dark:border-zinc-800">
      ...
      <div className="mt-2 flex items-end justify-between">
        <div>
          ...
          <p className="text-xs text-zinc-400">Median: {peerValue}{unit}</p>
        </div>
    ...
    >
      ...
      <div className="flex items-center gap-6">
        <div className="text-right">
          ...
          <p className="text-xs text-zinc-400">Total time</p>
        </div>
        <div className="text-right">
  ...
  return (
    <div className="rounded-lg border border-zinc-100 p-4 dark:border-zinc-800">
      ...
      {gap.recommendedChallenges.length > 0 && (
        <div className="mt-3">
          <p className="text-xs text-zinc-500">Recommended practice:</p>
...
function InsightRow({
  ...
  return (
    <div className="flex gap-3 rounded-lg bg-zinc-50 p-4 dark:bg-zinc-900/50">
      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white dark:bg-zinc-800">
    ...
    <div className="flex items-end justify-between gap-2">
      {data.map((count, index) => (
        <div key={index} className="flex flex-1 flex-col items-center gap-2">
          <div className="relative w-full">
            <div
              className={`rounded-t transition-all ${
                count > 0 ? "bg-emerald-500" : "bg-zinc-100 dark:bg-zinc-800"
              }`}
          ...
          <span className="text-xs text-zinc-400">{days[index]}</span>
        </div>
      ))}
    </div>
  );
