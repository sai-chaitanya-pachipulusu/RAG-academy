...
export function ResourcesView() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Search & Filters */}
      <section className="bg-white/80 py-3 backdrop-blur dark:bg-[#2563EB]/80">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <input
            ...
            className="h-10 rounded-xl border border-gray-200 bg-white px-4 text-sm placeholder:text-gray-400 focus:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-100 dark:border-gray-800 dark:bg-[#2563EB] dark:focus:border-indigo-800 dark:focus:ring-indigo-900/50"
          />
