  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-4 rounded-lg border border-gray-200 bg-gray-50 p-4">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#3B82F6] text-white">
        ...
        <Link
          href="/learn"
          className="inline-flex items-center gap-1.5 rounded-full bg-[#3B82F6] px-4 py-2 text-xs font-medium text-white hover:bg-[#2563EB] cursor-pointer"
        >
          View Curriculum
