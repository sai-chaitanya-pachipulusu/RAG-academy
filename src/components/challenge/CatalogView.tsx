...
export function CatalogView() {
  ...
  return (
    <div className="space-y-10">
      {/* Pro Tip Banner */}
      <Reveal>
        <div className="flex flex-col items-center gap-6 rounded-2xl border border-zinc-200 bg-zinc-50 p-8 sm:flex-row">
          ...
          <div className="flex-1 text-center sm:text-left">
            <p className="font-semibold text-zinc-900 text-base">Follow the structured path</p>
          ...
          <Link
            href="/learn"
            className="inline-flex items-center gap-2 rounded-full bg-zinc-900 px-6 py-3 text-sm font-medium text-white transition-all duration-200 hover:bg-zinc-800"
          >
            View Curriculum
