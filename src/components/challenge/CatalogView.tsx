    ...
    <div className="space-y-4">
      <div className="flex items-center gap-4 rounded-lg border border-zinc-200 bg-zinc-50 p-4">
        ...
        <div className="flex-1">
          <p className="text-sm font-semibold text-zinc-900">Follow the structured path</p>
        ...
        <Link
          href="/learn"
          className="inline-flex items-center gap-1.5 rounded-full bg-zinc-900 px-4 py-2 text-xs font-medium text-white hover:bg-zinc-800"
        >
          View Curriculum
